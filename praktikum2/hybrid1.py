...
mobilA = mobil("Honda", "Jazz", 2022, 1200, 4)
mobilA.nyalakan_mesin()
mobilA.memiliki_pintu()
mobilA.matikan_mesin()

motorA = motor("Honda", "Vario 125", 2021, 250, 2)
motorA.nyalakan_mesin()
motorA.berjalan()
motorA.matikan_mesin()

ev = mbl_listrik("Tesla", "Tesla", 2023, 2000, 4, 100)
ev.nyalakan_mesin()
ev.charge_baterai()
ev.charge_baterai()
ev.matikan_mesin()

e_bike = Electricmotor("bms", "01", 2023, 300, 2, 15.5)
